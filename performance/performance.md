...
Then the qb3 output images were converted back to PNG, also using the cqb3 conversion utility, which in turn 
...
PNG output size, the thicker brown line, varying between 14 and 150 milliseconds, with an average of 84 milliseconds.
...
QB3 consistently decompressed faster than PNG, although the difference is less noticeable than the compression

...
static const uint16_t SIGNAL[] = { 0, 0, 0, 0x5011, 0x6023, 0x7047, 0x808f };

// Decoding tables for codeswitch
static const uint16_t dsw3[] = { 0x5003, 0x4002, 0x3001, 0x3007, 0x5005, 0x4006, 0x3001, 0x3007, 0x5000, 0x4002, 0x3001,
